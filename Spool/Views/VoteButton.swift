...
struct VoteButton: View {
    ...
    var body: some View {
        ...
        // SF Symbol bounce when the arrow flips to its filled "voted"
        // state, and a numeric tween on the score so the +1 feels alive.
        .symbolEffect(.bounce.up, value: state.direction)
