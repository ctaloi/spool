...
final class SummaryViewModel: ObservableObject {
    ...
    func summarize(title: String, url: URL) {
        ...
        task = Task { [weak self] in
            ...
            // This is a user-tap-driven request. Tell the prefetch
            // gate so any in-flight background renders / summaries
            // cancel and free the LanguageModelSession + CPU for us.
            await PrefetchGate.shared.beginForeground()
            defer { Task { await PrefetchGate.shared.endForeground() } }
